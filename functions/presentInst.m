function presentInst(centsPerPoint)
...
instructStr = 'In this task you will choose between two options. \n \n After making a choice, there is a chance of receiving a shock to your finger. \n\n Press SPACE to continue.';
showInstructions(instructStr);

instImg = imread('functions\stimuli\inst1_s.jpg');
...
instImg = imread('functions\stimuli\inst2_s.jpg');
DiagramImg = Screen('MakeTexture', MainWindow, instImg);
Screen('DrawTexture', MainWindow, DiagramImg);
Screen(MainWindow, 'Flip');
RestrictKeysForKbCheck(KbName('Space'));   % Only accept spacebar
